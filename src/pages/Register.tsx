...
const Register = () => {
 ...
 register(data)
     ...
     const backgroundStyle = {
         ...
         backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("https://image.lexica.art/full_webp/1484d18f-ebb0-4921-b3a8-548bb7ed697b")',
 ...
 <SocialLoginCard/>
    ...
    <Row justify="center" align="middle" className="max-w-md mx-auto p-5 mt-8">
      <Form onSubmit={onSubmit} >
        <FormInput type="text" name="username" label="User Name" />
        <FormInput type="email" name="email" label="Email" />
        <FormInput type="text" name="password" label="Password" />
        <Button htmlType="submit"  className="w-96 px-4 py-2 font-bold text-white bg-purple-500 rounded-md hover:bg-purple-700">
          {isLoading ? "Signing Up" : "Sign Up"}
        </Button>
      </Form>
    </Row>
    <p className="text-purple-400"><a href="/login">Already have an account?</a></p>
    </div>
    </div>
     </div>
  </div>
